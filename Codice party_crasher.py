...
test_progressivi_regioni_mesi= covid_regioni.groupby(["RegionName","Mese"])["TestsPerformed"].max().reset_index()
print(test_progressivi_regioni_mesi)
test_progressivi= test_progressivi_regioni_mesi.groupby("Mese")["TestsPerformed"].sum().reset_index() 
...
tot_positivi_progressivi_regioni_mesi= covid_regioni.groupby(["RegionName","Mese"])["TotalPositiveCases"].max().reset_index()
positivi_progressivi= tot_positivi_progressivi_regioni_mesi.groupby("Mese")["TotalPositiveCases"].sum().reset_index()
print(positivi_progressivi)
...
sns.lineplot(positivi_progressivi, x="Mese", y="TotalPositiveCases", label = "Totale Positivi")
